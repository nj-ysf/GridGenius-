...
P_PV_INSTALLED = 10.0
P_LOAD_MAX     = 40.0
LAT, LON       = 33.6897, -7.3897   # ENSET Mohammedia

MODELS_DIR = Path(__file__).parent / "models"
MODELS_DIR.mkdir(exist_ok=True)

# PV profile based on real Mohammedia irradiance (Open-Meteo Archive 2023-2024)
PV_PROFILE = {
...
CONSO_PROFILE = {
    ...
    14:28, 15:30, 16:28, 17:22, 18:8, 19:5, 20:4, 21:3.5, 22:3, 23:2.8
}
